...
[パス金庫 V001.000.000 をダウンロード](https://github.com/takumiappdev-rgb/PassKinko/releases/tag/V001.000.000)

ダウンロードするファイルは以下です。

```text
PassKinko_V001.000.000_Windows.zip
```
...
1. `PassKinko_V001.000.000_Windows.zip` をダウンロードします
2. ZIPを展開します
...
このリポジトリには、パス金庫 V001.000.000 のソースコード、ビルド用bat、仕様書、テスト資料を含めています。
